...
This is a "teach the teacher" course. The goal is to have our session enable other Red Hatters to run CTF competitions around the product (Ansible Automation Platform). 
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/ansible-island-adventure`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/ansible-island-adventure
   ```
3. `cd ansible-island-adventure`
